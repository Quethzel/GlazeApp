...
export class GlazeService {
  glazes: Glaze[] = [
    { id: '0000', name: 'Azul Cobalto', isDecorative: true, isFoodSafe: false, viscosity: 'Semi-Fluido', opacity: 'Transparente', finish: 'Brillante', surface: 'Lisa', temperature: 'Alta', recommendedThickness: '3 - 4 capas', recommendedFiring: 'Cone 7', recommendedClay: 'Stoneware, 301', notes: 'No apto para alimentos.', imageUrl: 'assets/glazes/AzulCobalto.webp' },
    ...
    { id: 'FFFF', name: 'Arena de Mar', isDecorative: true, isFoodSafe: true, viscosity: 'Estable', opacity: 'Opaco', finish: 'Mate', surface: 'Texturizada', temperature: 'Alta', recommendedThickness: '2 capas', recommendedFiring: 'Cone 8', recommendedClay: '401', notes: 'No se recomienda en arcillas blancas, ya que se pierde el color.', imageUrl: 'assets/glazes/ArenaDeMar.webp' },
